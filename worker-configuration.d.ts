/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b0b4c3d734aeaecf8e827f3aa33e07f2)
// Runtime types generated with workerd@1.20250525.0 2025-05-17 
declare namespace Cloudflare {
	interface Env {
		CF_NUXT_KV: KVNamespace;
		API_HOST: string;
		DEBUG: string;
		SECRET_TOKEN: string;
	}
